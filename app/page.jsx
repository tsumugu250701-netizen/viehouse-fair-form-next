          ...
          <section className="formSection" id="survey">
            ...
            >
              ...
              <div className="question">
                <h2>
                  Q1. Vie houseを知ったきっかけは？ <small>（複数選択可）</small>
                </h2>
              ...
              <div className="question">
                <h2>
                  Q2. 家づくりで気になっていることは？ <small>（複数選択可）</small>
                </h2>
              ...
              <p className="privacy">
                ご入力いただいた個人情報は、厳重に管理し、ご連絡・ご案内目的以外には使用いたしません。
              </p>

              <button className="submitBtn" type="submit">
                アンケートを送信する <span>›</span>
              </button>
            </form>
  ...
  return (
    <section className="footerBlock">
      <div className="footerReserve">
        ...
        <a href="https://youtu.be/sgWQRtHu3s4" target="_blank" rel="noopener noreferrer">
  ...
  return (
    <section className="thanksPage">
      <div className="thanksCard">
        ...
        <strong className="thanksPhone">048-584-7779</strong>
      </div>
